class Game2048 {
    constructor() {
        this.grid = [];
        this.score = 0;
        this.bestScore = localStorage.getItem('bestScore5x5') || 0;
    ...
    updateScore() {
        ...
        if (this.score > this.bestScore) {
            ...
            localStorage.setItem('bestScore5x5', this.bestScore);
        }
    ...
    hasWon() {
        for (let i = 0; i < this.size; i++) {
            for (let j = 0; j < this.size; j++) {
                if (this.grid[i][j] === 8192) { // Win at 8192 for 5x5
                    return true;
                }
            }
        }
